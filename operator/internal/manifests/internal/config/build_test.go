...
#
# Values for not exposed fields are taken from the frelon/loki production
# configuration manifests.
# (See https://github.com/frelon/loki/v2/blob/main/production/ksonnet/loki/config.libsonnet)
limits_config:
  ...
  # (See https://github.com/frelon/loki/v2/blob/main/pkg/ingester/limiter.go#L73)
