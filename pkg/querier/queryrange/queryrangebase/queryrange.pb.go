...
type SampleStream struct {
	Labels  []github_com_frelon_loki_pkg_logproto.LabelAdapter `protobuf:"bytes,1,rep,name=labels,proto3,customtype=github.com/grafana/loki/v2/pkg/logproto.LabelAdapter" json:"metric"`
