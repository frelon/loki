...
import (
	...
	github_com_frelon_loki_pkg_querier_queryrange_queryrangebase "github.com/frelon/loki/v2/pkg/querier/queryrange/queryrangebase"
)
...
type LokiResponse struct {
	...
	Headers    []github_com_frelon_loki_pkg_querier_queryrange_queryrangebase.PrometheusResponseHeader `protobuf:"bytes,9,rep,name=Headers,proto3,customtype=github.com/frelon/loki/v2/pkg/querier/queryrange/queryrangebase.PrometheusResponseHeader" json:"-"`
}
...
type LokiSeriesResponse struct {
	...
	Headers []github_com_frelon_loki_pkg_querier_queryrange_queryrangebase.PrometheusResponseHeader `protobuf:"bytes,4,rep,name=Headers,proto3,customtype=github.com/frelon/loki/v2/pkg/querier/queryrange/queryrangebase.PrometheusResponseHeader" json:"-"`
}
...
type LokiData struct {
	...
	Result     []github_com_frelon_loki_pkg_logproto.Stream `protobuf:"bytes,2,rep,name=Result,proto3,customtype=github.com/frelon/loki/v2/pkg/logproto.Stream" json:"result"`
}
...
var fileDescriptor_51b9d53b40d11902 = []byte{
	...
	,
}
