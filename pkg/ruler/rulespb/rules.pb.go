...
type RuleDesc struct {
	...
	Labels      []github_com_frelon_loki_pkg_logproto.LabelAdapter `protobuf:"bytes,5,rep,name=labels,proto3,customtype=github.com/frelon/loki/v2/pkg/logproto.LabelAdapter" json:"labels"`
	Annotations []github_com_frelon_loki_pkg_logproto.LabelAdapter `protobuf:"bytes,6,rep,name=annotations,proto3,customtype=github.com/frelon/loki/v2/pkg/logproto.LabelAdapter" json:"annotations"`
}
