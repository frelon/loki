...
type AlertStateDesc struct {
	...
	Labels      []github_com_frelon_loki_pkg_logproto.LabelAdapter `protobuf:"bytes,2,rep,name=labels,proto3,customtype=github.com/frelon/loki/v2/pkg/logproto.LabelAdapter" json:"labels"`
	Annotations []github_com_frelon_loki_pkg_logproto.LabelAdapter `protobuf:"bytes,3,rep,name=annotations,proto3,customtype=github.com/frelon/loki/v2/pkg/logproto.LabelAdapter" json:"annotations"`
